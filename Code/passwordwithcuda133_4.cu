...
/****************************************************************************
  ...
  Compile and run with:
    nvcc -o passwordwithcuda133_4 passwordwithcuda133_4.cu
    ./passwordwithcuda133_4
...
__device__ int is_a_match(char *attempt) {
	char plain_password1[] = "SU12";
	char plain_password2[] = "NI23";
	char plain_password3[] = "LS37";
	char plain_password4[] = "TH94";
